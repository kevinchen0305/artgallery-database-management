...
<!-- Work Row -->
        <div class="w3-row-padding w3-padding-64 w3-theme-l1" id="gallerydb">
            <div class="w3-quarter">
                <h2>Salesperson Performance Report</h2>
                <p>Reports on the sales of individual salespeople for the current quarter or the past year</p>
            </div>

            <div class="w3-threequarter">
                <div class="w3-card w3-white">
                    <div class="w3-container">
                        <table border = 5, class="salespersontable">
                            <tr>
                                <th>Starting Date</th>
                                <th>Ending Date</th>
                                <th>Salesperson</th>
                            ...
                            $salespersonData = getSalespersoninfo($current_year);
                            for($index=0;$index < count($salespersonData);$index++){
                                $salesperson = $salespersonData[$index];
                                echo "<tr>";
                                echo "<td>".$current_year."-1-1</td>";
                                echo "<td>".$current_year."-12-31</td>";
                                echo "<td>".$salesperson->get_Salesperson()."</td>";
                                echo "<td>".$salesperson->get_CustName()."</td>";
                                echo "<td>1 Year</td>";
                                echo "<td>".$salesperson->get_Title()."</td>";
                                echo "<td>".$salesperson->get_Artist()."</td>";
                                echo "<td>".$salesperson->get_AskingPrice()."</td>";
                                echo "<td>".$salesperson->get_SellingPrice()."</td>";
                                echo "</tr>";
                            }

                            $salespersonData = getSalespersoninfo($last_year);
                            for($index=0;$index < count($salespersonData);$index++){
                                $salesperson = $salespersonData[$index];
                                echo "<tr>";
                                echo "<td>".$last_year."-1-1</td>";
                                echo "<td>".$last_year."-12-31</td>";
                                echo "<td>".$salesperson->get_Salesperson()."</td>";
                                echo "<td>".$salesperson->get_CustName()."</td>";
                                echo "<td>1 Year</td>";
                                echo "<td>".$salesperson->get_Title()."</td>";
