...
<!-- Work Row -->
        <div class="w3-row-padding w3-padding-64 w3-theme-l1" id="gallerydb">
            <div class="w3-quarter">
                <h2>Customers</h2>
                <p>The data about each customer</p>
            </div>

            <div class="w3-threequarter">
                <div class="w3-card w3-white">
                    <div class="w3-container">
                        <table border = 5, class="custable">
                            <tr>
                                <th>Customer Name</th>
                                <th>Address</th>
                                <th>Telephone</th>
                                <th>Dollar Amount of Last Year's Purchases</th>
                                <th>Dollar Amount of This Year's Purchases</th>
                            </tr>
                            <?php
                            $customerData = getCustomerInfo();
                            for($index=0;$index < count($customerData);$index++){
                                $customer = $customerData[$index];
                                echo "<tr>";
                                echo "<td>".$customer->get_CustName()."</td>";
                                echo "<td>".$customer->get_CustAddress()."</td>";
                                echo "<td>".$customer->get_CustPhone()."</td>";
                                echo "<td>".$customer->get_BoughtLastYear()."</td>";
                                echo "<td>".$customer->get_BoughtThisYear()."</td>";
                                echo "</tr>";
                            }
                            ?>
                        </table>
