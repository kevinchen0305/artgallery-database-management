...
<!-- Work Row -->
        <div class="w3-row-padding w3-padding-64 w3-theme-l1" id="gallerydb">
            <div class="w3-quarter">
                ...
                <a href="customer.php#gallerydb" class="w3-bar-item w3-button w3-hide-small w3-hover-white"><li>Customers</li></a>
            </div>
                    ...
                    <div class="w3-container">
                        <?php
                            ...
                            while($data = $result->fetch_assoc()){
                                ...
                                $images .= "<div class='Image'><img src='../customerimage/{$data['Filename']}' width='150' height='150' ><h2>$file_name_withoutjpg</h2></div>";
                             }
