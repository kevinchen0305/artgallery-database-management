                    ...
                    <div class="w3-container">
                        <table border = 5, class="aatable">
                            <tr>
                                ...
                                <th>Usual Medium</th>
                                <th>Usual Style</th>       
                                <th>Last Year's Sales</th>
                                <th>This Year's Sales</th>
                            </tr>
                            <?php
                            $artistData = getArtistinfo();
                            for($index=0;$index < count($artistData);$index++){
                                $artist = $artistData[$index];
                                echo "<tr>";
                                echo "<td>".$artist->get_Name()."</td>";
                                echo "<td>".$artist->get_Address()."</td>";
                                echo "<td>".$artist->get_Phone()."</td>";
                                echo "<td>".$artist->get_UsualType()."</td>";
                                echo "<td>".$artist->get_UsualMedium()."</td>";
                                echo "<td>".$artist->get_UsualStyle()."</td>";
                                echo "<td>".$artist->get_SaleLastYear()."</td>";
                                echo "<td>".$artist->get_SaleThisYear()."</td>";
                                echo "</tr>";
                            }
                            ?>
                        </table>
