...
<!-- Work Row -->
        <div class="w3-row-padding w3-padding-64 w3-theme-l1" id="gallerydb">
            <div class="w3-quarter">
                ...
                <p>The data about each work</p>
            </div>

            <div class="w3-threequarter">
                <div class="w3-card w3-white">
                    <div class="w3-container">
                        <table border = 5, class="worktable">
                            <tr>
                                <th>Title</th>
                                <th>Artist</th>
                                <th>Type</th>  
                            ...
                            <?php
                            $workData = getWorkinfo();
                            for($index=0;$index < count($workData);$index++){
                                $work = $workData[$index];
                                echo "<tr>";
                                echo "<td>".$work->get_Title()."</td>";
                                echo "<td>".$work->get_Artist()."</td>";
                                echo "<td>".$work->get_Type()."</td>";
                                echo "<td>".$work->get_Medium()."</td>";
                                echo "<td>".$work->get_Style()."</td>";
                                echo "<td>".$work->get_Artist()."</td>";
                                echo "<td>".$work->get_AskingPrice()."</td>";
                                echo "<td>".$work->get_DateOfShow()."</td>";
                                echo "</tr>";
                            }
                            ?>
                        </table>
